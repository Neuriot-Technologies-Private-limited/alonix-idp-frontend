    ...
    <div className="w-full min-w-0 space-y-5 animate-in fade-in slide-in-from-bottom-4 duration-1000 pb-[max(2.5rem,env(safe-area-inset-bottom))] sm:space-y-8">
        ...
        <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:flex-wrap sm:justify-end">
          {isCompanyAdmin ? (
            <button
              ...
              className="flex w-full shrink-0 items-center justify-center gap-2.5 rounded-2xl border border-border/10 bg-surface-highest/40 px-5 py-3 font-bold text-[11px] uppercase tracking-widest text-foreground shadow-none transition-all hover:bg-surface-highest/60 active:scale-95 sm:w-auto sm:px-6 sm:py-3.5"
            >
          ...
          <button
            ...
            className="flex w-full shrink-0 items-center justify-center gap-2.5 rounded-2xl border border-border/10 bg-primary px-5 py-3 font-bold text-[11px] uppercase tracking-widest text-primary-foreground shadow-[0_20px_40px_rgba(173,198,255,0.2)] transition-all hover:opacity-90 active:scale-95 sm:w-auto sm:px-6 sm:py-3.5"
          >
      ...
      <section className="flex flex-col items-stretch gap-3 sm:gap-4 md:flex-row md:items-center">
        <SearchInput
          ...
          showClear
          className="w-full"
          inputClassName="rounded-2xl pl-11 py-4 text-[13px] focus:ring-4 focus:ring-primary/10 backdrop-blur-xl border-border/10"
        />
        <div className="flex bg-surface-highest/5 p-1.5 rounded-2xl border border-border/10 backdrop-blur-xl shrink-0">
          <button
